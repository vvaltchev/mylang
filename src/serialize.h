 ...
 * same commit.
 */
constexpr unsigned MYV_FORMAT_VERSION = 23;   /* v23: MapFilterV's target2
                                                 carries the flat result
                                                 kind in bits 1-2 (#97 CB3);
                                                 v22: a third loc table
                                                 per chunk, `op_locs` (the
                                                 compound-operation
                                                 carets); v21: the foreach
                                                 shift guard's two
                                                 APPENDED opcodes */
